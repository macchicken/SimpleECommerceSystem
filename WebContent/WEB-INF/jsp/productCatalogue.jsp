...
<tbody>
<c:forEach var="product" items= "${products.proList}" varStatus="productCount">
            <tr>
            <td>${product.title}</td>
...
<div id="pageArea">
	<c:forEach var="i" begin="1" end="${products.totalPage}">
		<a href="products/search?keyword=${products.keyWords}&pageNumber=${i}&continued=true" value="${i}">${i}</a>&nbsp
	</c:forEach>
